    ...
    return (
        <View>
            <View style={[styles.container, {backgroundColor: theme.card}, style]}>
                ...
                <TextInput style={[styles.textInput, {color: theme.fontStd}]} placeholder={'Type to search'}
                           onChangeText={onChange} onFocus={() => setIsActive(true)}
                           onBlur={() => setIsActive(false)}/>
                <TouchableOpacity activeOpacity={ACTIVE_OPACITY}
                                  onPress={() => console.log("hi, this doesn't do anything...")}>
                    <CIcon icon={'filter'} size={ICON_SIZE.l24} withBgColor={theme.cardDark} color={theme.fontInverse}
